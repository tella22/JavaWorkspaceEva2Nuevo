...
public class EjemPropagar_b {
	...
	public static void main(String[] args) {
		...
		catch(NumberFormatException e){ //si se produce el error no lo captura esta cath porque lo trata el metodo pedirEntero
	...
	static int pedirEntero(){ //capturamos el error dentro del metodo y ya no se propaga
		String cadena;
		int num=0;
		cadena=pedirCadena();
		try{
		num=Integer.parseInt(cadena);
		}catch(NumberFormatException e){ // y ya no se propaga al metodo main
			System.out.println("\nSe han insertado letras en lugar de numeros." +
